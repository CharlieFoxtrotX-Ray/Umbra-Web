...
(function () {
  ...
  const T = {
    ...
    es: {
      ...
      'faq.q2': '¿La prueba pide tarjeta?', 'faq.a2': 'No. Empiezas gratis, sin tarjeta. Recién al día 15, cuando tu servidor de prueba está por cerrarse, te pedimos la tarjeta para mantenerlo vivo y ampliarlo.',
      ...
      'dlm.eyebrow': 'Antes de instalar',
      'dlm.title': 'Windows aún no nos conoce 👀',
      'dlm.body': 'Estamos terminando nuestra verificación oficial con Windows. Mientras tanto, al abrir el instalador te saldrá un aviso azul de seguridad. Es totalmente normal y UMBRA es 100% seguro — solo hay que decirle a Windows que confíe en nosotros:',
      'dlm.s1.html': 'Cuando salga la ventana azul, pulsa <b>«Más información»</b>.',
      'dlm.s2.html': 'Abajo aparecerá el botón <b>«Ejecutar de todas formas»</b>. Púlsalo.',
      'dlm.s3.html': '¡Listo! Sigue la instalación con normalidad. 🎉',
      'dlm.go': '↓ Descargar de todas formas', 'dlm.cancel': 'Ahora no',
      'dlm.note': 'Este aviso desaparecerá pronto, cuando Windows reconozca nuestra firma. Gracias por la confianza 💚',

      // ── Programa de Partners ──
      'pp.eyebrow': 'Programa de Partners',
      'pp.h1.html': 'Tu comunidad ya confía en ti.<br/><span class="gold">Que eso te pague.</span>',
      'pp.lead': 'Recomienda UMBRA a tu audiencia y gana una comisión recurrente de todo lo que gasten tus referidos — hasta un 20%. Pago cada mes, y lingotes de regalo para enganchar a tu gente.',
      'pp.hero.cta': 'Quiero unirme →', 'pp.hero.cta2': 'Cómo funciona',
      'pp.how.h2.html': 'Tres pasos, <span class="gold">cero fricción.</span>',
      'pp.how.sub': 'Sin mínimos para entrar, sin cuotas. Solo compartes y cobras.',
      'pp.how.s1.t': 'Aplica en 1 minuto', 'pp.how.s1.d': 'Rellena el formulario con tu canal. Revisamos que encaje y te damos tu código y tu link único.',
      'pp.how.s2.t': 'Comparte tu link', 'pp.how.s2.d': 'En tus vídeos, streams, bio o descripción. Quien se registre con tu link queda asociado a ti durante 12 meses.',
      'pp.how.s3.t': 'Cobra cada mes', 'pp.how.s3.d': 'Acumulas comisión por cada compra de tus referidos. Te transferimos lo recaudado mensualmente.',
      'pp.tiers.h2.html': 'Cuanto más mueves, <span class="gold">más te llevas.</span>',
      'pp.tiers.sub': 'Tu comisión sube por tramos según lo que generan tus referidos cada mes. Empiezas en 10% el día uno.',
      'pp.tier1.name': 'Creator', 'pp.tier1.sub': 'Tu punto de entrada al ser aprobado.',
      'pp.tier1.f1': '10% de lo que gastan tus referidos', 'pp.tier1.f2': 'Comisión recurrente durante 12 meses', 'pp.tier1.f3': 'Tu link y código personalizados',
      'pp.tier2.ribbon': 'El más popular', 'pp.tier2.name': 'Partner', 'pp.tier2.sub': 'Al llegar a $300/mes o 25 referidos que compran.',
      'pp.tier2.f1': 'Todo lo de Creator, al 15%', 'pp.tier2.f2': 'Prioridad en soporte y novedades', 'pp.tier2.f3': 'Material gráfico para tu contenido',
      'pp.tier3.name': 'Elite', 'pp.tier3.sub': 'Al llegar a $1.000/mes o 75 referidos que compran.',
      'pp.tier3.f1': 'Todo lo de Partner, al 20%', 'pp.tier3.f2': 'Lingotes para sorteos con tu comunidad', 'pp.tier3.f3': 'Co-marketing y destacado oficial',
      'pp.ref.h3': 'Tu audiencia también gana 🎁',
      'pp.ref.p.html': 'Quien entre con tu link se lleva un <b>+10% de lingotes extra en su primera recarga</b>. Tú tienes algo real que ofrecer, ellos ahorran, y todos ganan.',
      'pp.found.h3': '¿Vas en serio? Founding Partner ⭐',
      'pp.found.p.html': 'Firma un acuerdo de 12 meses y desbloqueas extras: <b>pack de lingotes para sorteos</b>, destacado en nuestros canales y acceso anticipado a novedades. ¿La comisión? Esa te la ganas tú — <b>el tier sube metiendo referidos que compran</b>, no se regala.',
      'pp.form.h2.html': 'Aplica para ser <span class="gold">partner.</span>',
      'pp.form.sub': 'Cuéntanos de tu canal. Si encaja, te escribimos en 2-3 días con tu link y los siguientes pasos.',
      'pp.form.name': 'Nombre o alias *', 'pp.form.email': 'Email *',
      'pp.form.platform': 'Plataforma principal *', 'pp.form.platform.ph': 'Elige una…', 'pp.form.platform.other': 'Otra',
      'pp.form.audience': 'Tamaño de audiencia *', 'pp.form.audience.ph': 'Elige un rango…',
      'pp.form.channel': 'Link de tu canal principal *', 'pp.form.games': '¿Qué juegos o contenido haces?',
      'pp.form.message': 'Algo más que quieras contarnos',
      'pp.form.consent.html': 'Acepto que UMBRA me contacte sobre el programa y he leído la <a href="/privacidad.html" target="_blank">política de privacidad</a>.',
      'pp.form.submit': 'Enviar solicitud', 'pp.form.sending': 'Enviando…',
      'pp.thanks.h2': '¡Solicitud recibida! 🎉',
      'pp.thanks.p': 'Gracias por querer crecer con UMBRA. Revisamos tu canal y te escribimos en 2-3 días con tu link de partner y los siguientes pasos.',
      'pp.faq.h2': 'Preguntas frecuentes',
      'pp.faq.q1': '¿Cuándo y cómo cobro?', 'pp.faq.a1': 'Cada mes te transferimos lo acumulado, a partir de un mínimo de $25 (si no llegas, se acumula para el mes siguiente). Tú nos envías tu factura como creador y nosotros pagamos.',
      'pp.faq.q2': '¿Sobre qué se calcula la comisión?', 'pp.faq.a2': 'Sobre lo que tus referidos gastan en lingotes dentro de UMBRA, neto de comisiones de pago y reembolsos, durante sus primeros 12 meses contigo.',
      'pp.faq.q3': '¿Tengo que firmar algo o hay exclusividad?', 'pp.faq.a3': 'No es obligatorio. Puedes ser partner sin contrato. Si quieres, firmas como Founding Partner por extras (lingotes para sorteos, destacado, acceso anticipado) — pero tu comisión y tu tier siempre te los ganas tú con tus referidos.',
      'pp.faq.q4': '¿Qué cuenta como referido válido?', 'pp.faq.a4': 'Un usuario nuevo que se registra con tu link y luego compra. No se admiten auto-referidos ni cuentas tuyas: lo revisamos y los pagos con fraude se anulan.',
      'ft.tag': 'Un producto de CFX, pensado por y para gamers.',
      'ft.h1': 'Producto', 'ft.download': 'Descargar', 'ft.h2': 'Recursos', 'ft.status': 'Estado del servicio', 'ft.partners': 'Partners · Creadores', 'ft.faq': 'FAQ',
    ...
    en: {
      ...
      'faq.q2': 'Does the trial ask for a card?', 'faq.a2': 'No. You start free, no card. Only on day 15, when your trial server is about to close, do we ask for a card to keep it alive and expand it.',
      ...
      'dlm.eyebrow': 'Before you install',
      'dlm.title': 'Windows doesn’t know us yet 👀',
      'dlm.body': 'We’re finishing our official verification with Windows. In the meantime, when you open the installer you’ll see a blue security warning. It’s completely normal and UMBRA is 100% safe — you just need to tell Windows to trust us:',
      'dlm.s1.html': 'When the blue window appears, click <b>“More info”</b>.',
      'dlm.s2.html': 'A <b>“Run anyway”</b> button will show up below. Click it.',
      'dlm.s3.html': 'Done! Continue the installation as usual. 🎉',
      'dlm.go': '↓ Download anyway', 'dlm.cancel': 'Not now',
      'dlm.note': 'This warning will disappear soon, once Windows recognizes our signature. Thanks for trusting us 💚',

      // ── Partner Program ──
      'pp.eyebrow': 'Partner Program',
      'pp.h1.html': 'Your community already trusts you.<br/><span class="gold">Let it pay off.</span>',
      'pp.lead': 'Recommend UMBRA to your audience and earn a recurring commission on everything your referrals spend — up to 20%. Paid monthly, plus bonus lingotes to hook your people.',
      'pp.hero.cta': 'Join now →', 'pp.hero.cta2': 'How it works',
      'pp.how.h2.html': 'Three steps, <span class="gold">zero friction.</span>',
      'pp.how.sub': 'No entry minimums, no fees. You just share and get paid.',
      'pp.how.s1.t': 'Apply in 1 minute', 'pp.how.s1.d': 'Fill in the form with your channel. We check the fit and give you your code and unique link.',
      'pp.how.s2.t': 'Share your link', 'pp.how.s2.d': 'In your videos, streams, bio or description. Anyone who signs up with your link is tied to you for 12 months.',
      'pp.how.s3.t': 'Get paid monthly', 'pp.how.s3.d': 'You earn commission on every purchase your referrals make. We transfer your earnings each month.',
      'pp.tiers.h2.html': 'The more you move, <span class="gold">the more you keep.</span>',
      'pp.tiers.sub': 'Your commission climbs in tiers based on what your referrals generate each month. You start at 10% on day one.',
      'pp.tier1.name': 'Creator', 'pp.tier1.sub': 'Your entry point once approved.',
      'pp.tier1.f1': '10% of what your referrals spend', 'pp.tier1.f2': 'Recurring commission for 12 months', 'pp.tier1.f3': 'Your own link and custom code',
      'pp.tier2.ribbon': 'Most popular', 'pp.tier2.name': 'Partner', 'pp.tier2.sub': 'Once you hit $300/mo or 25 paying referrals.',
      'pp.tier2.f1': 'Everything in Creator, at 15%', 'pp.tier2.f2': 'Priority support and early news', 'pp.tier2.f3': 'Graphic assets for your content',
      'pp.tier3.name': 'Elite', 'pp.tier3.sub': 'Once you hit $1,000/mo or 75 paying referrals.',
      'pp.tier3.f1': 'Everything in Partner, at 20%', 'pp.tier3.f2': 'Lingotes for giveaways with your community', 'pp.tier3.f3': 'Co-marketing and official feature',
      'pp.ref.h3': 'Your audience wins too 🎁',
      'pp.ref.p.html': 'Anyone who joins with your link gets <b>+10% bonus lingotes on their first top-up</b>. You have something real to offer, they save, everybody wins.',
      'pp.found.h3': 'Serious about it? Founding Partner ⭐',
      'pp.found.p.html': 'Sign a 12-month agreement and unlock perks: a <b>pack of lingotes for giveaways</b>, a feature across our channels, and early access to what\'s coming. The commission? You earn that — <b>your tier goes up by bringing referrals who buy</b>, it\'s not handed to you.',
      'pp.form.h2.html': 'Apply to become a <span class="gold">partner.</span>',
      'pp.form.sub': 'Tell us about your channel. If it fits, we\'ll reach out in 2-3 days with your link and next steps.',
      'pp.form.name': 'Name or alias *', 'pp.form.email': 'Email *',
      'pp.form.platform': 'Main platform *', 'pp.form.platform.ph': 'Choose one…', 'pp.form.platform.other': 'Other',
      'pp.form.audience': 'Audience size *', 'pp.form.audience.ph': 'Choose a range…',
      'pp.form.channel': 'Link to your main channel *', 'pp.form.games': 'What games or content do you make?',
      'pp.form.message': 'Anything else you want to tell us',
      'pp.form.consent.html': 'I agree to be contacted by UMBRA about the program and I have read the <a href="/privacidad.html" target="_blank">privacy policy</a>.',
      'pp.form.submit': 'Send application', 'pp.form.sending': 'Sending…',
      'pp.thanks.h2': 'Application received! 🎉',
      'pp.thanks.p': 'Thanks for wanting to grow with UMBRA. We\'ll review your channel and reach out in 2-3 days with your partner link and next steps.',
      'pp.faq.h2': 'Frequently asked questions',
      'pp.faq.q1': 'When and how do I get paid?', 'pp.faq.a1': 'Every month we transfer your accrued earnings, from a $25 minimum (below that it rolls over to the next month). You send us your creator invoice and we pay.',
      'pp.faq.q2': 'What is the commission calculated on?', 'pp.faq.a2': 'On what your referrals spend on lingotes inside UMBRA, net of payment fees and refunds, during their first 12 months with you.',
      'pp.faq.q3': 'Do I have to sign anything or is there exclusivity?', 'pp.faq.a3': 'It\'s not required. You can be a partner with no contract. If you want, you sign as a Founding Partner for perks (lingotes for giveaways, a feature, early access) — but your commission and your tier are always earned with your referrals.',
      'pp.faq.q4': 'What counts as a valid referral?', 'pp.faq.a4': 'A new user who signs up with your link and then buys. Self-referrals and your own accounts don\'t count: we review them and fraudulent payouts are voided.',
      'ft.tag': 'A CFX product, made by and for gamers.',
      'ft.h1': 'Product', 'ft.download': 'Download', 'ft.h2': 'Resources', 'ft.status': 'Service status', 'ft.partners': 'Partners · Creators', 'ft.faq': 'FAQ',
