...
(function () {
  ...
  const T = {
    ...
    es: {
      ...
      'ws.mod2.title': 'Calendario', 'ws.mod2.text': 'Disponibilidad coloreada por miembro. Cuándo está cada uno, qué ops tenéis, en un sitio.',
      ...
      'st.eyebrow': '✨ CÓMO VA',
      'st.h2': 'Cuatro pasos. Sin friolera.',
      ...
      'ap.omni.title': '¡Soy Omni!', 'ap.omni.text': 'Yo guardo los lingotes que aportáis · ni uno se pierde.',
      ...
      'pn.tb.lead': 'Precios en lingotes (la moneda interna). 1 lingote ≈ $2. Y recuerda que con aportes del equipo, el líder rara vez paga el total.',
      ...
      'faq.foot': 'Pasa el ratón por encima para pausar y leer con calma.',
      ...
      'faq.q2': 'Tengo un móvil de 2018. ¿Servirá?',
      ...
      'faq.a4': 'La moneda interna. Sirve para activar planes, aportar a tu org, comprar premium o regalar. Se ganan o se compran.',
      ...
      'faq.q9': '¿Mis llamadas son privadas? ¿Vendéis datos?',
      'faq.a9': 'Voz cifrada en tránsito. No grabamos salvo que tú lo actives. Y no vendemos datos — el modelo es la suscripción.',

      'cta.h2': '¿Te animas?',
      'cta.lead': 'Descarga UMBRA, abre tu primera sala y prueba el whisper. Si no te gusta, te devuelvo el lingote (y son gratis, así que ya ves).',
    ...
    en: {
      ...
      'pn.tb.lead': 'Prices in lingots (our internal currency). 1 lingot ≈ $2. And remember: with team contributions, the leader rarely pays the full amount.',
      ...
      'faq.a4': 'Our internal currency. Used to activate plans, contribute to your org, buy premium or gift. Earn them or buy them.',
      ...
      'cta.h2': 'You in?',
      'cta.lead': 'Download UMBRA, open your first room and try whisper. If you don\'t like it, I\'ll refund your lingot (they\'re free, so figure that out).',
