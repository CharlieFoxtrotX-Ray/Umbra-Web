...
(function () {
  ...
  const T = {
    ...
    es: {
      ...
      'pp.found.h3': '¿Listo para comprometerte? Founding Partner ⭐',
      'pp.found.p.html': 'Firma un acuerdo de 12 meses y arrancas directo en <b>tier Partner (15%) los primeros 90 días</b>, con un pack de lingotes para sorteos y destacado en nuestros canales. Sin letra pequeña: es una ventaja, no una atadura.',
      ...
      'pp.faq.q3': '¿Tengo que firmar algo o hay exclusividad?', 'pp.faq.a3': 'No es obligatorio. Puedes ser partner sin contrato. Si quieres, firmas como Founding Partner para arrancar con más comisión y extras — pero es opcional.',
    ...
    en: {
      ...
      'pp.found.h3': 'Ready to commit? Founding Partner ⭐',
      'pp.found.p.html': 'Sign a 12-month agreement and start straight at <b>Partner tier (15%) for the first 90 days</b>, with a pack of lingotes for giveaways and a feature across our channels. No fine print: it\'s a perk, not a leash.',
      ...
      'pp.faq.q3': 'Do I have to sign anything or is there exclusivity?', 'pp.faq.a3': 'It\'s not required. You can be a partner with no contract. If you want, you sign as a Founding Partner to start with higher commission and perks — but it\'s optional.',
