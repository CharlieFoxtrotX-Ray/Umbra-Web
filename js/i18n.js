...
(function () {
  ...
  const T = {
    ...
    es: {
      ...
      'pricing.community.f1.html': 'Hasta <strong>10 miembros</strong> por canal',
    ...
    en: {
      ...
      'pricing.community.f1.html': 'Up to <strong>10 members</strong> per channel',
    ...
    fr: {
      ...
      'pricing.community.f1.html': 'Jusqu’à <strong>10 membres</strong> par canal',
    ...
    de: {
      ...
      'pricing.community.f1.html': 'Bis zu <strong>10 Mitglieder</strong> pro Kanal',
    ...
    pt: {
      ...
      'pricing.community.f1.html': 'Até <strong>10 membros</strong> por canal',
      'pricing.community.f2': 'Salas de voz ilimitadas',
    ...
    zh: {
      ...
      'pricing.community.f1.html': '每频道最多 <strong>10 名成员</strong>',
